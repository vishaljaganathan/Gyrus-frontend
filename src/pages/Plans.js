...
const Plans = () => {
  const courses = [
    ...
    },
    {
      ...
      description: "The crash courses offered by Gyrus ensures intensive short–term condensed learning opportunity, orchestrated to quickly refresh the concepts already assimilated. Students are entitled to participate in multiple special test-series providing concentrated learning experience making it ideal for the students, for a better retention, focusing on the key concepts and strategies.",
      features: ["Unlimited Exercises", "37 Years NTA NEET MCQs", "Unlimited Model Exams"],
      price: "₹ 349",
      originalPrice: "₹ 699",
      buttonText: "Subscribe Now"
      ...
      <section className="plans-section">
        <div className="container">
          ...
          <h4 className="fw-bold">
            ...
            Pick your perfect fit and<br />
            <span className="text-dark">unlock endless possibilities today!</span>
          </h4>
